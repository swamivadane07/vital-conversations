      ...
      <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              {emergencySigns.map((sign, index) => (
                <div key={index} className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-destructive-foreground">{sign}</span>
                </div>
              ))}
            </div>
          </CardContent>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-2">
              ...
              <div className="text-xs text-accent-foreground">
                <p className="font-medium mb-1">Find Nearest Hospital</p>
                <p className="mb-2">Enable location services for fastest emergency response</p>
                <Button 
                  size="sm" 
                  variant="outline" 
                  className="text-xs h-7 border-accent-foreground/20"
                >
                  Enable Location
                </Button>
              </div>
        ...
        <div className="p-3 bg-muted/50 border border-border rounded-lg">
          <p className="text-xs text-muted-foreground text-center">
            <strong>Remember:</strong> In any life-threatening situation, call 911 immediately. 
